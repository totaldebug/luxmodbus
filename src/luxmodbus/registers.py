...
HOLD_REGISTERS: tuple[RegisterDef, ...] = (
    ...
    RegisterDef(
        ...
        writable=True,
        value_min=0,
        value_max=200,  # spec nominal is 140, but live hardware reports 146
    ),
    RegisterDef(
        ...
        writable=True,
        value_min=0,
        value_max=200,  # spec nominal is 140, widened to match live hardware (see charge_current_limit)
    ),
    RegisterDef(
        ...
        writable=True,
        value_min=0,
        value_max=150,  # spec nominal is 100, but live hardware reports 120
    ),
    RegisterDef(
        ...
        unit=PCT,
        writable=True,
        value_min=0,  # spec nominal min is 10, but live hardware reports 5
        value_max=90,
    ),
    ...
    # --- Discovered on live hardware, confirmed against spec Table 8 ----------
    #
    # Scales validated against the values these returned on a real inverter.
    # Lead-acid temperature limits (106-109) are signed (the discharge lower
    # limit read -20.0 °C); 106/107 are the discharge pair, 108/109 the charge
    # pair (109 is the spec's "limit for charging").
    RegisterDef(
        "lead_acid_temp_lower_discharge",
        106,
        "Lead-acid Temp Lower (Discharge)",
        RegisterBank.HOLD,
        Measurement.TEMPERATURE,
        type=ValueType.S16,
        scale=0.1,
    ...
    RegisterDef(
        "lead_acid_temp_upper_discharge",
        107,
        "Lead-acid Temp Upper (Discharge)",
        RegisterBank.HOLD,
        Measurement.TEMPERATURE,
        type=ValueType.S16,
        scale=0.1,
    ...
    RegisterDef(
        "lead_acid_temp_lower_charge",
        108,
        "Lead-acid Temp Lower (Charge)",
        RegisterBank.HOLD,
        Measurement.TEMPERATURE,
        type=ValueType.S16,
        scale=0.1,
    ...
    RegisterDef(
        "lead_acid_temp_upper_charge",
        109,
        "Lead-acid Temp Upper (Charge)",
        RegisterBank.HOLD,
        Measurement.TEMPERATURE,
        type=ValueType.S16,
        scale=0.1,
    ...
    RegisterDef(
        "gen_charge_start_voltage",
        194,
        "Generator Charge Start Voltage",
        RegisterBank.HOLD,
        Measurement.VOLTAGE,
        scale=0.1,
        unit=V,
    ...
    RegisterDef(
        "gen_charge_end_voltage",
        195,
        "Generator Charge End Voltage",
        RegisterBank.HOLD,
        Measurement.VOLTAGE,
        scale=0.1,
        unit=V,
    ...
    RegisterDef(
        "gen_charge_start_soc",
        196,
        "Generator Charge Start SOC",
        RegisterBank.HOLD,
        Measurement.PERCENT,
        unit=PCT,
        writable=True,
    ...
    RegisterDef(
        "smart_load_on_voltage",
        213,
        "Smart Load On Voltage",
        RegisterBank.HOLD,
        Measurement.VOLTAGE,
        scale=0.1,
        unit=V,
    ...
    RegisterDef(
        "smart_load_off_voltage",
        214,
        "Smart Load Off Voltage",
        RegisterBank.HOLD,
        Measurement.VOLTAGE,
        scale=0.1,
        unit=V,
    ...
    RegisterDef(
        "ac_couple_start_voltage",
        222,
        "AC Couple Start Voltage",
        RegisterBank.HOLD,
        Measurement.VOLTAGE,
        scale=0.1,
        unit=V,
    ...
    RegisterDef(
        "ac_couple_end_voltage",
        223,
        "AC Couple End Voltage",
        RegisterBank.HOLD,
        Measurement.VOLTAGE,
        scale=0.1,
        unit=V,
    ...
    # --- Grid-support: frequency derate (spec Table 8) -----------------------
    #
    # All default-off. Frequency points use wide Hz bounds — the spec's nominal
    # ranges (50-52 / 45-50 Hz) did not match the live hardware.
    RegisterDef(
        "over_freq_derate_delay",
        97,
        "Over-Freq Derate Delay",
        RegisterBank.HOLD,
        writable=True,
        value_min=0,
        value_max=1000,
    ...
    RegisterDef(
        "over_freq_derate_start",
        115,
        "Over-Freq Derate Start",
        RegisterBank.HOLD,
        Measurement.FREQUENCY,
        scale=0.01,
        unit=HZ,
    ...
    RegisterDef(
        "over_freq_derate_end",
        124,
        "Over-Freq Derate End",
        RegisterBank.HOLD,
        Measurement.FREQUENCY,
        scale=0.01,
        unit=HZ,
    ...
    RegisterDef(
        "under_freq_derate_start",
        134,
        "Under-Freq Derate Start",
        RegisterBank.HOLD,
        Measurement.FREQUENCY,
        scale=0.01,
        unit=HZ,
    ...
    RegisterDef(
        "under_freq_derate_end",
        135,
        "Under-Freq Derate End",
        RegisterBank.HOLD,
        Measurement.FREQUENCY,
        scale=0.01,
        unit=HZ,
    ...
    RegisterDef(
        "over_freq_derate_ratio",
        136,
        "Over-Freq Derate Ratio",
        RegisterBank.HOLD,
        unit="%/Hz",
        writable=True,
        value_min=1,
    ...
    RegisterDef(
        "under_freq_increase_ratio",
        193,
        "Under-Freq Increase Ratio",
        RegisterBank.HOLD,
        unit="%/Hz",
        writable=True,
        value_min=1,
    ...
    # --- Grid-support: Volt-Watt / Vref Q(V) curve (spec Table 8) -------------
    #
    # Reactive-power / volt-watt curve points. The curve percentages (187-192)
    # have no documented range in the spec, so they ship unbounded.
    RegisterDef(
        "volt_watt_v1",
        181,
        "Volt-Watt V1",
    ...
    RegisterDef(
        "q3_qv", 187, "Q3 Q(V)", RegisterBank.HOLD, Measurement.PERCENT, unit=PCT, writable=True, enabled_default=False
    ),
    RegisterDef(
        "q4_qv", 188, "Q4 Q(V)", RegisterBank.HOLD, Measurement.PERCENT, unit=PCT, writable=True, enabled_default=False
    ),
    RegisterDef(
        "p1_qp", 189, "P1 Q(P)", RegisterBank.HOLD, Measurement.PERCENT, unit=PCT, writable=True, enabled_default=False
    ),
    RegisterDef(
        "p2_qp", 190, "P2 Q(P)", RegisterBank.HOLD, Measurement.PERCENT, unit=PCT, writable=True, enabled_default=False
    ),
    RegisterDef(
        "p3_qp", 191, "P3 Q(P)", RegisterBank.HOLD, Measurement.PERCENT, unit=PCT, writable=True, enabled_default=False
    ),
    RegisterDef(
        "p4_qp", 192, "P4 Q(P)", RegisterBank.HOLD, Measurement.PERCENT, unit=PCT, writable=True, enabled_default=False
    ),
    # --- Peak-shaving (spec Table 8) -----------------------------------------
    RegisterDef(
    ...
    RegisterDef(
        "grid_peak_shaving_voltage",
        208,
        "Grid Peak Shaving Voltage",
        RegisterBank.HOLD,
        Measurement.VOLTAGE,
        scale=0.1,
        unit=V,
    ...
    RegisterDef(
        "grid_peak_shaving_voltage_2",
        219,
        "Grid Peak Shaving Voltage 2",
        RegisterBank.HOLD,
        Measurement.VOLTAGE,
        scale=0.1,
        unit=V,
...
TIME_REGISTERS: tuple[TimeRegister, ...] = (
    ...
    # Peak-shaving and generator schedule windows (spec Table 8, default-off).
    TimeRegister("peak_shaving_start", 209, "Peak Shaving Start", enabled_default=False),
    TimeRegister("peak_shaving_end", 210, "Peak Shaving End", enabled_default=False),
    TimeRegister("peak_shaving_start_2", 211, "Peak Shaving Start 2", enabled_default=False),
    TimeRegister("peak_shaving_end_2", 212, "Peak Shaving End 2", enabled_default=False),
    TimeRegister("gen_start", 256, "Generator Start", enabled_default=False),
    TimeRegister("gen_end", 257, "Generator End", enabled_default=False),
    TimeRegister("gen_start_2", 258, "Generator Start 2", enabled_default=False),
    TimeRegister("gen_end_2", 259, "Generator End 2", enabled_default=False),
)
